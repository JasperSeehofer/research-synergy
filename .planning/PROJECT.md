...
**v1.1.1 progress:** Phase 11 (SPA routing) done, Phase 12 (graph rendering) done, Phase 13 (graph interaction) done — CSS pointer-events fix. Phase 14 (temporal controls) remaining.
