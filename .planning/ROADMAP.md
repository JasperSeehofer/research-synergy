...
Plans:
- [ ] 999.1-01-PLAN.md — Data pipeline: extend GraphNode/NodeState with top_keywords, define LabelMode enum, server function AnalysisRepository join
- [ ] 999.1-02-PLAN.md — K-means clustering module: Lloyd's algorithm, convex hull, auto_k heuristic, dominant keyword aggregation
- [ ] 999.1-03-PLAN.md — Label mode dropdown + per-node keyword pill rendering with score-based opacity
