...
# --- Paths ---
DATA_FILE      = 'data/research_synergy_kuramoto_full.json'
...
ax.axis('off')
plt.tight_layout()
plt.savefig('kuramoto_v05_bridges.png', dpi=120, bbox_inches='tight')
plt.show()
print('Figure saved: kuramoto_v05_bridges.png')
...
# ============================================================================
print('=' * 80)
print('KURAMOTO-LBD v0.5 (EXP-RS-12) — RESULTS SUMMARY')
print('=' * 80)
...
with open('data/kuramoto_v05_results.json', 'w') as _f:
    _json.dump(_results, _f, indent=1)
print('\n[v05] results -> data/kuramoto_v05_results.json')
