...
/// A WASM-safe color type replacing egui::Color32 for WASM compatibility.
...
pub const GRAY_UNANALYZED: PaperColor = PaperColor::from_rgb(140, 140, 140);

/// Default node color for the raw (non-enriched) view.
pub const DEFAULT: PaperColor = PaperColor::from_rgb(128, 128, 128);
...
pub fn paper_type_to_color(paper_type: &str) -> PaperColor {
    match paper_type.to_lowercase().as_str() {
        "theoretical" => PaperColor::from_rgb(100, 140, 200),
        "experimental" => PaperColor::from_rgb(90, 170, 110),
        "review" => PaperColor::from_rgb(200, 160, 70),
        "computational" => PaperColor::from_rgb(150, 100, 190),
        _ => GRAY_UNANALYZED,
    }
}
