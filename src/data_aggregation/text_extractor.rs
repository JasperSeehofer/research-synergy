...
"#,
        ...
        assert_eq!(sections.abstract_text, Some("This is the abstract.".to_string()));
        ...
        assert_eq!(sections.conclusion, Some("Conclusion text here.".to_string()));
    }
...
"#,
        ...
        let html = Html::parse_document(&html_str);
        let sections = parse_sections(&html);
        assert_eq!(sections.abstract_text, Some("Abstract of the paper.".to_string()));
        assert_eq!(sections.introduction, Some("Introduction content.".to_string()));
    }
